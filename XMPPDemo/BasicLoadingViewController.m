...
//    CLog(@"startPoint  x==%f y==%f",startPoint.x,startPoint.y);
//    
//}
//
...
//    point1 = endPoint;
//    CLog(@"endPoint  x==%f y==%f",endPoint.x,endPoint.y);
//    
...
//    CLog(@"point.x==%f  point.y==%f",point.x,point.y);
